      ...
      <div className="w-full max-w-sm mx-auto px-4">
        <div className="bg-white dark:bg-surface-900 rounded-2xl shadow-lg p-8 space-y-6">
          ...
          <div className="space-y-2 text-center">
            <div className="h-6 w-40 bg-surface-200 dark:bg-surface-700 rounded animate-pulse mx-auto" />
            <div className="h-4 w-52 bg-surface-100 dark:bg-surface-800 rounded animate-pulse mx-auto" />
          </div>
