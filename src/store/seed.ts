...
export function generateSeedData(
  ...
  if (sites.length >= 2) {
    tasks.push(
      ...
      { id: tid('205'), title: `${cn[0]} — done`, site: sites[1].name, siteId: sites[1].id, category: cn[0], priority: 'medium', due: yesterday, assignee: e15.name, assigneeId: e15.id, teamId: t2Id, status: 'Completed', assignedBy: lead2.name, assignedByRole: 'subadmin', approved: true, createdAt: twoDaysAgo, completedAt: yesterday, lastActivityAt: yesterday },
