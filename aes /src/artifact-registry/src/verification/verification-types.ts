...
export type CheckSpec =
  | { type: "builtin"; check: BuiltInCheck }
  | { type: "single"; command: string; checkName: string };
...
// ─── Retry Context (fed into next attempt) ───────────────────────────────────
...
export const DEFAULT_LOW_RISK_POLICY: VerificationPolicy = {
...
export const DEFAULT_BACKEND_POLICY: VerificationPolicy = {
  pass_1_checks: [{ type: "builtin", check: "typecheck" }],
...
export const DEFAULT_HIGH_RISK_POLICY: VerificationPolicy = {
  pass_1_checks: [{ type: "builtin", check: "typecheck" }],
  pass_2_checks: [{ type: "builtin", check: "test" }],
  final_checks: [
...
export const DEFAULT_FRONTEND_POLICY: VerificationPolicy = {
  pass_1_checks: [{ type: "builtin", check: "typecheck" }],
  pass_2_checks: [{ type: "builtin", check: "test" }],
  final_checks: [
