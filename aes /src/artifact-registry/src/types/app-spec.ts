...
export type AppPromotionStatus =
  | "DRAFT"
  | "CANDIDATE"
  | "VERIFIED"
  | "PROMOTED"
...
export interface FeatureSpec {
  ...
  name: string;
  description: string;
  feature_type: string; // maps to CanonicalFeatureClass or custom
  donor_mappings: DonorMapping[];
  dependencies: string[]; // feature_ids this depends on
  user_roles: string[];
