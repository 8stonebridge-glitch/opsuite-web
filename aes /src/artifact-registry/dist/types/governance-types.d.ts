...
export interface TrainableGovernance {
    ...
    routing_thresholds: {
        direct_build_floor: number;
        caution_build_floor: number;
        research_required_floor: number;
    };
    ...
    promotion_thresholds: {
        ...
        max_missing_questions_per_feature: number;
        /** Distinct successful builds needed for CANONICAL */
        builds_for_canonical: number;
    ...
    escalation_rules: {
        ...
        max_files_per_module_before_escalation: number;
        /** Auto-escalate if > N scope expansion requests on a single build */
        max_scope_expansions_before_escalation: number;
    };
    /** Blocked-state rules */
    blocked_state_rules: {
...
export interface GovernanceConfig {
    ...
    promotion_status: "CANDIDATE" | "SANDBOX_TESTED" | "VERIFIED_RESTRICTED" | "VERIFIED" | "CANONICAL" | "DEMOTED";
