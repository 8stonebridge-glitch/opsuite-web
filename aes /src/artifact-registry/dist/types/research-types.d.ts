...
export declare const EMPTY_FRONTEND_PATTERNS: FrontendPatterns;
export declare const EMPTY_BACKEND_ARCHITECTURE: BackendArchitecture;
export declare const EMPTY_SECURITY_RESEARCH: SecurityResearch;
export declare const EMPTY_PITFALL_RESEARCH: PitfallResearch;
export declare const EMPTY_OPERATOR_MANUAL_STEPS: OperatorManualSteps;
export declare const EMPTY_STRUCTURED_RESEARCH: StructuredResearchSummary;
