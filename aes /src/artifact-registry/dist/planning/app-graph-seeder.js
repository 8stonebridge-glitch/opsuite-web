...
exports.AppGraphSeeder = exports.NotPromotedError = void 0;
class NotPromotedError extends Error {
    constructor(appId, decision) {
        super(`Cannot seed app ${appId}: promotion decision is ${decision}, expected PROMOTED`);
        this.name = "NotPromotedError";
    }
}
exports.NotPromotedError = NotPromotedError;
// ─── Seeder ────────────────────────────────────────────────────────────────────
class AppGraphSeeder {
    constructor(executor, now = () => new Date()) {
...
exports.AppGraphSeeder = AppGraphSeeder;
//# sourceMappingURL=app-graph-seeder.js.map