...
function hasPathCoverage(candidate, allowedPaths) {
...
function collectValidationIssues(input) {
    ...
    if (!Array.isArray(bridge.write_scope.paths) ||
    ...
    const computedConfidence = (0, types_1.computeConfidence)(bridge.confidence_breakdown);
...
//# sourceMappingURL=bridge-validator.js.map