...
exports.extendedPanelsHtml = extendedPanelsHtml;
exports.pipelineCanvasScript = pipelineCanvasScript;
exports.extendedPanelScripts = extendedPanelScripts;
class AgentActivityTracker {
    ...
    setApp(appId) { this.appId = appId; }
    setFeature(featureId) { this.featureId = featureId; }
    setTotals(total, completed, failed, blocked) {
...
exports.AgentActivityTracker = AgentActivityTracker;
// ─── Extended Dashboard HTML ─────────────────────────────────────────────────
function extendedPanelsHtml() {
    return `
<!-- ══════════════════════════════════════════════════════════════════════════ -->
...
//# sourceMappingURL=agent-pipeline-view.js.map